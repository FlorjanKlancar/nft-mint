  ...
  return (
    <div className="grid h-1/3 grid-cols-1 md:h-screen md:grid-cols-3 md:space-x-2 ">
      ...
      <div className="col-span-2">
        <div className="da flex flex-col items-center  justify-center p-5">
          <div className="w-full rounded-xl bg-base-300 p-5 text-sm shadow shadow-gray-200 dark:bg-gray-700 dark:shadow-gray-700 md:text-base lg:order-2">

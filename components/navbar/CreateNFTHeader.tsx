...
function CreateNFTHeader() {
  ...
  return (
    <div className="md:px-12">
      <div className="mb-6 flex w-full flex-col items-center justify-between rounded-lg bg-base-content/30 p-5 px-8 text-base-content shadow-secondary/20 md:mb-0 md:flex-row">
        <div className="mt-4 flex w-full flex-col justify-around space-y-3 text-center text-lg text-gray-600 md:mt-0 md:flex-row md:space-x-4 md:space-y-0">

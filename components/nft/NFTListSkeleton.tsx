  ...
  function renderSkeletons(amount: number) {
    ...
    for (let i = 0; i < amount; i++) {
      skeletons.push(
        <div
          key={i}
          className="my-2 flex w-full cursor-pointer  flex-col items-center justify-center space-y-2 rounded-xl border-2 border-neutral border-opacity-50 bg-base-300 bg-gradient-to-b shadow-lg shadow-neutral/30 transition-all duration-300 sm:w-3/4 md:w-5/6 md:justify-start md:hover:scale-110 lg:my-8  xl:w-[250px]"
        >
